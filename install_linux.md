...
6. Download this repository by running `git clone --recursive https://github.com/Adex-8x/mm6-patches.git` in the terminal. c-of-time will be downloaded in a folder called `c-of-time` inside the current directory.
